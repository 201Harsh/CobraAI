        ...
        <div className="flex flex-col-reverse md:flex-row w-full h-full items-center justify-between md:mt-0 mt-2">
          ...
          >
            <motion.div
              ...
              className={"bg-indigo-100 rounded-full px-6 py-2 sm:px-7 sm:py-2 flex items-center justify-center gap-2"}
            >
            ...
            >
              ...
              learning pace and style. Get real-time code feedback, personalized
              lesson plans, and instant answers to your programming questions
