        ...
        {showFollowPopup && (
          ...
          >
            <motion.div
              ...
              animate={{ scale: 1, y: 0 }}
              exit={{ scale: 0.9, y: 20 }}
              className="relative bg-gray-800/95 border border-red-800 rounded-xl w-full max-w-md max-h-[95vh] p-4 sm:p-6 overflow-y-auto shadow-2xl"
            >
              <button
              ...
              <div className="flex flex-col items-center text-center space-y-4">
                ...
                <p className="text-gray-400 text-sm sm:text-base">
                  Help keep{" "}
                  <span className="font-semibold text-red-400">MambaAI AI</span>{" "}
                  free and growing
                </p>
