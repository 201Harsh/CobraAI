...
import { FaComments, FaCode, FaTimes, FaInstagram, FaGithub } from "react-icons/fa";
        ...
        {showFollowPopup && (
          ...
          >
            <motion.div
              ...
              animate={{ scale: 1, y: 0 }}
              exit={{ scale: 0.9, y: 20 }}
              className="relative bg-gray-800/95 border-gray-700 border rounded-xl max-w-md w-full p-6 shadow-2xl"
            >
              <button
